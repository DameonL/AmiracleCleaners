...
class ShoppingCart extends HTMLElement {
    ...
    async #renderCartItem(itemIndex) {
        ...
        let url = `https://firestore.googleapis.com/v1/projects/amiracle-cleaners/databases/(default)/documents/products/${cartItem.productId}`;
        ...
        item.fields.shortDescription = { stringValue: item.fields.variants.arrayValue.values[variant].mapValue.fields.description.stringValue };
        item.fields.variant = { doubleValue: variant };
        item.fields.image = { stringValue: item.fields.variants.arrayValue.values[variant].mapValue.fields.image.stringValue };
